 ...
 */
class WriterAggregationMapper[K, V, C](shuffleWriteCurator: ShuffleWriteCurator,
                                       serializer: Serializer,
                                       bufferOptions: BufferManagerOptions,
                                       shuffleDependency: ShuffleDependency[K, V, C])
  extends WriterBufferManager[K, V, C](shuffleWriteCurator, serializer, bufferOptions) {
